      ...
      <div className="container relative z-10 mx-auto px-4 text-center md:px-6">
        ...
        <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
          <Button
            ...
            onClick={scrollToPricing} // Assuming you might want to scroll to a pricing section
          >
          ...
          <Button
            size="lg"
            variant="outline"
            className="w-full sm:w-auto transition-transform duration-200 ease-in-out hover:scale-105"
          >
            Learn More
          </Button>
          */}
